...
def run_infinite_post_data_loop():
    '''
    This function runs an indefinite loop which simulates a real-time stream of data. It also 
    creates 3 json serialised dictionaries, which are then sent to the API.
    '''
